...
const CollaboratorSearch: React.FC<CollaboratorSearchProps> = ({
  ...
  return (
    <Sheet>
      ...
      <SheetContent className="w-[400px] sm:w-[540px] bg-[#f4f4f4]">
        <SheetHeader>
        ...
        >
          <Search />
          <Input name="name" placeholder="Search" onChange={onChangeHandler} />
        </div>
        <ScrollArea
          className="mt-6
          overflow-y-scroll
          ...
          {searchResults
            ...
            .map((user) => (
              ...
              >
                ...
                <Button
                  variant="secondary"
                  className="bg-[#111111] h-5 rounded-xl hover:bg-[#000000] text-white"
