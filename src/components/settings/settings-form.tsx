...
const SettingsForm = () => {
  ...
  return (
    <div className="flex gap-4 flex-col">
      ...
      <>
        <Separator className="bg-[#b8b8b8] my-5" />
        ...
        {permissions === "shared" && (
          <div>
            ...
            <div className="mt-4">
              <span className="text-xs text-[#090909]">
        ...
        <Alert variant={"destructive"}>
          ...
          <Button
            type="submit"
            size={"sm"}
            className="mt-4 text-sm bg-red-600 border text-white border-red-600"
            onClick={async () => {
              if (!workspaceId) return;
        ...
        <Separator className="bg-[#b8b8b8] mt-5" />

        <p className="flex items-center gap-2 mt-3 text-sm mb-10">
        ...
        <div className="flex items-center">
          ...
          <div className="flex flex-col ml-6">
            ...
            <Label htmlFor="profilePicture" className="text-sm text-[#090909]">
              Profile Picture
            </Label>
            <Input
              name="profilePicture"
        ...
        <p className="flex items-center gap-2 mt-3 text-[#090909] text-sm mb-10">
          <CreditCard size={15} /> Billing & Plan
        </p>
        <div className="flex justify-between">
          <p className="text-[#090909] text-xs">
          ...
          <Link
            href="/"
            target="_blank"
            className="text-[#090909] text-xs flex flex-row items-center gap-2 underline"
          >
            View Plans <ExternalLink size={15} />
          </Link>
        </div>
        {subscription?.status === "active" ? (
          <div>
            <Button
              ...
              className="text-xs text-white bg-[#50b86a] w-full"
